            ...
            <form className="w-full max-w-lg my-10 pb-10">
                <div className=" flex-wrap -mx-3 mb-6">
                    <div className="w-full px-3">
                        ...
                        <input className="appearance-none block w-full bg-[#FFFFFF] text-gray-700 border focus:border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-name" type="text" placeholder="Opara Linus Ahmed" />
                    </div>
                ...
                <div className="flex gap-5">
                    <div className="flex flex-wrap -mx-3 mb-6 w-[60%]">
                        <div className="w-full px-3">
                            ...
                            <input className="appearance-none block w-full bg-[#FFFFFF] text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-red-500" id="grid-address1" type="tel" placeholder="44960 44960 44960 44960" maxLength="20" />
                    ...
                    <div className="flex w-full -mx-3 mb-2 w-[20%]">
                        <div className="w-full px-3 mb-6 md:mb-0">
                            ...
                            <input className="appearance-none block w-full bg-[#FFFFFF] text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-red-500" id="grid-Local_Government" type="tel" placeholder="923" maxLength="3" />
                        </div>
